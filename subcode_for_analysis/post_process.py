...
df = pd.read_csv("REJECT/js.csv")
print(df.columns)
json_data = download_disconnect_list()

if json_data:
    # Step 2: Load and process
    df_javascript = apply_disconnect_categories_to_dataframe(df, domain_column='domain_script_url')
...
symbol_categories = {
    ...
    'WebGL Fingerprinting': webgl_info_symbols,
    'Audio Fingerprinting': audio_fingerprinting_symbols,
    'Sensor Fingerprinting': device_sensor_symbols,
